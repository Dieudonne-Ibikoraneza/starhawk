        ...
        <Card className={`${dashboardTheme.card}`}>
          <CardContent className="p-12">
            <div className="flex items-center justify-center">
              ...
              <span className="text-gray-900/60">Loading policies...</span>
            </div>
          </CardContent>
        </Card>
      ) : policies.length === 0 ? (
        <Card className={`${dashboardTheme.card}`}>
          <CardContent className="p-12">
            <div className="text-center text-gray-900/60">
              <Activity className="h-12 w-12 mx-auto mb-4 text-gray-900/40" />
              ...
              <Card key={policy._id} className={`${dashboardTheme.card}`}>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-900/70">Monitoring Cycles:</span>
                      <span className="text-gray-900">{monitoringCount}/2</span>
                    </div>
                    <div className="flex justify-between">
